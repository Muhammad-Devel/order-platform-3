...
<div className="text-center mt-8">
  <p className="text-gray-700 mb-4">Ready to taste the best cakes in town?</p>
  <a href="/shop" className="bg-blue-500 text-white py-2 px-6 rounded-md hover:bg-blue-600">
    Shop Now
  </a>
</div>
